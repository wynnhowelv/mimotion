...
min_dict = {time_list[0]: 1000, time_list[1]: 1300, time_list[2]: 2500, time_list[3]: 3000, time_list[4]: 3500, time_list[5]: 5000, time_list[6]: 6000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 1200, time_list[1]: 1500, time_list[2]: 3000, time_list[3]: 3200, time_list[4]: 4000, time_list[5]: 5500, time_list[6]: 8000}
# 设置结束
